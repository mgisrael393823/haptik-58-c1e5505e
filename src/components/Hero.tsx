...
export function Hero() {
  ...
  return <div className="w-full relative">
      ...
      <AuroraBackground className="w-full">
        <div className="w-full flex flex-col rounded-3xl bg-accent text-accent-foreground relative isolate overflow-hidden sm:gap-y-16 gap-y-8 md:p-12 p-6 px-[48px]">
